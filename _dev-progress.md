...
|-------|-------|-------|-----|--------|
| S1 | Lab Onboarding & Auth | auth, compliance | AC-1.1…1.6 (6) | 🧪 scoring · QA bridged 8→9: +10 route-handler integration tests · 30/30 tests · re-run /5-eo-score (expect 90) |
...
## Next
`/5-eo-score` → re-run for S1 (QA gap bridged). Expect composite 90 → `/7-eo-ship`.

---
**Last updated:** 2026-06-01 · **Current sprint:** 1 / ~5 · **Last command:** `/6-eo-bridge-gaps qa` (S1)
