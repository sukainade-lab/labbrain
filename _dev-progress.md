...
|-------|-------|-------|-----|--------|
| S1 | Lab Onboarding & Auth | auth, compliance | AC-1.1…1.6 (6) | 🧪 scoring · review=✓ (1 🔴 fixed) · 20/20 tests · build+lint green · awaiting /5-eo-score |
...
## Next
`/5-eo-score` → 5-hat scorecard for S1 (≥8 per hat, ≥90 composite to ship).

---
**Last updated:** 2026-06-01 · **Current sprint:** 1 / ~5 · **Last command:** `/4-eo-review` (S1)
